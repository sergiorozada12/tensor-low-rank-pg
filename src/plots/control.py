...
def plot_control():
    ...
    with plt.style.context(["science"], ["ieee"]):
        ...
        ax.plot(med, label="RBF - 603 pars.", alpha=0.8, color="y")
        ax.fill_between(range(p25.shape[0]), p25, p75, alpha=0.2, color="y")
        ...
        ax.fill_between(range(p25.shape[0]), p25, p75, alpha=0.2, color="g")
        ...
        ax.fill_between(range(p25.shape[0]), p25, p75, alpha=0.2, color="r")
