...
if __name__ == "__main__":
    ...
    np.save('mountaincar_discrete_reinforce_rbf.npy', results)
    ...
    results = np.array(results)
    np.save('mountaincar_discrete_ppo_rbf.npy', results)
    ...
    results = np.array(results)
    np.save('mountaincar_discrete_trpo_rbf.npy', results)
